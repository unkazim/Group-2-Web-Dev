...
<script>
    ...
    function calculateTotal() {
		...
		if (fromDate && toDate) {
            ...
            var daysDiff = Math.ceil(timeDiff / (1000 * 3600 * 24)) + 1; // Including the last day
            var totalPrice = daysDiff * dailyRate;
            $('#totalPrice').text('MYR ' + totalPrice.toFixed(2));
        }
    }
</script>
<style>
...
<div class="selectroom">
    <div class="container"> 
        ...
        <form name="book" method="post">
            ...
            <input type="hidden" id="dailyRate" value="<?php echo htmlentities($result->PackagePrice); ?>">
        </form>
        <?php }} ?>
    </div>
</div>
